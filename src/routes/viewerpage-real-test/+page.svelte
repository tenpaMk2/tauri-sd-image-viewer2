<script lang="ts">
	...
	const testImagePath =
		'/Users/tenpamk2/Downloads/sample-sets/00136-catTowerNoobaiXL_v18Vpred_to-love-ru-yui-no-lora_long-sleeves-navel-kenzen_sitting-head-tilt-index-finger-raised_stairs-on-elevated-mid_embarrassed-closed-mouth-effect_civok_ani6dr6og8us5ks4.png';
...
<!-- テスト説明ヘッダー -->
<div class="fixed top-0 right-0 left-0 z-50 bg-info p-2 text-center text-info-content">
	<span class="font-bold">🧪 ViewerPage Real Test</span> -
	実際のViewerPageコンポーネントの動作テスト -
	<a href="/" class="btn ml-2 btn-outline btn-xs">← Back to Welcome</a>
</div>
